...
public class Connexion {
	...
	public static int connexion(String identifiant, String mdp) throws SQLException {
		...
		// Connexion ecurie
		ResultSet rese = ConnexionBD.Query("select mdp from ecurie where nom='"+identifiant+"'");
		if (rese.next()) {
		...
		// Connexion arbitre
		ResultSet resa = ConnexionBD.Query("select mdp from arbitre where login='"+identifiant+"'");
		if (resa.next()) {
